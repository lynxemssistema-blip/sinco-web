...
export default function CameraPage() {
 ...
 <div className="bg-card border border-border rounded-md shadow-sm p-8 flex flex-col items-center text-center hover:border-primary/50 transition-colors">
 ...
 <div className="relative w-full max-w-lg aspect-[3/4] md:aspect-video bg-black rounded-md overflow-hidden shadow-2xl border-4 border-white ring-4 ring-black/10">
 <video
 ref={videoRef}
 autoPlay
 playsInline
 ...
 <div className="bg-card p-2 rounded-md border shadow-lg max-w-lg w-full">
 <img src={capturedImage} alt="Capture" className="w-full rounded-md" />
 </div>
