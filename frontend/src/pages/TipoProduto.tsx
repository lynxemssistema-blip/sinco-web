...
export default function TipoProdutoPage() {
 ...
 <th className="px-3 py-1.5 text-left text-xs font-semibold text-white uppercase tracking-wider">Tipo Produto</th>
 <th className="px-3 py-1.5 text-left text-xs font-semibold text-white uppercase tracking-wider w-24">Unidade</th>
 ...
 <td className="px-3 py-1.5 text-sm text-gray-600">{item.Unidade || '-'}</td>
 <td className="px-3 py-1.5 text-sm text-gray-600 truncate max-w-[300px]">{item.Descricao || '-'}</td>
 <td className="px-3 py-1.5">
