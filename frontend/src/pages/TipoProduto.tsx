                        ...
                        <table className="w-full">
                            <thead className="bg-[#567469] text-white bg-[#567469] text-white">
                                <tr className=" border-b border-white/20">
                                    ...
                                    <th className="px-4 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider">Tipo Produto</th>
                                    <th className="px-4 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider w-24">Unidade</th>
