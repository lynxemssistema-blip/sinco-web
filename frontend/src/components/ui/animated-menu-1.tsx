...
export default function AnimatedMenuComponent() {
 ...
 {/* Header */}
 <header className="relative z-20 px-4 py-2 flex items-center justify-between">
 <motion.button
 ...
 className={`p-8 rounded-md shadow-xl ${isDark ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'
 }`}
 >
 ...
 className={`mt-8 p-8 rounded-md shadow-xl ${isDark ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'
 }`}
 >
